...
(function() {
   ...
   var photoIdModel = function(userId, photoId) {
      return photos.filter(function (photo) {
         return (photo.user_id === userId && photo._id === photoId);
      });
   };
   
   var commentOfUserModel = function(userId) {
   ...
   var cs142models =  {
      ...
      commentOfUserModel: commentOfUserModel,
      photoIdModel: photoIdModel,
